...
import (
	...
	pbgameengine "github.com/eduardohitek/m-apis/m-game-engine/v1"
	"github.com/eduardohitek/m-game-engine/internal/server/logic"
...
func (g *Grpc) GetSize(context.Context, *pbgameengine.GetSizeRequest) (*pbgameengine.GetSizeResponse, error) {
